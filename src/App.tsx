...
import { OrbitControls, Text, Stats, TrackballControls, FirstPersonControls, MapControls, ArcballControls, FlyControls, DeviceOrientationControls } from '@react-three/drei'
