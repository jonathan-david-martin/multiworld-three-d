import {
  OrbitControls,
  PerspectiveCamera
} from "./chunk-DA4ALUJV.js";
import "./chunk-6RPMZDRQ.js";
import {
  useFrame
} from "./chunk-HCT37PA3.js";
...
import {
  Vector3
} from "./chunk-BHGYI2PP.js";
import {
  __toModule
} from "./chunk-WC6BDPVA.js";

// node_modules/react-three-fpscontrols/dist/esm/index.js
...
var handleMove = function(evt, data) {
...
function useKeyboard(param) {
  var enableKeyboard = param.enableKeyboard;
...
function useJoystick(param) {
  var enableJoystick = param.enableJoystick;
...
var FPSControls = function(param) {
  var _enableJoystick = param.enableJoystick, enableJoystick = _enableJoystick === void 0 ? true : _enableJoystick, _enableKeyboard = param.enableKeyboard, enableKeyboard = _enableKeyboard === void 0 ? true : _enableKeyboard, _orbitProps = param.orbitProps, orbitProps = _orbitProps === void 0 ? {} : _orbitProps, _camProps = param.camProps, camProps = _camProps === void 0 ? {} : _camProps, _mult = param.mult, mult = _mult === void 0 ? 0.1 : _mult;
  var orbitRef = (0, import_react.useRef)();
  var camRef = (0, import_react.useRef)();
  var meshRef = (0, import_react.useRef)();
  var updatePlayer = (0, import_react.useCallback)(function() {
    var mesh = meshRef.current;
    var controls = orbitRef.current;
    var camera = camRef.current;
    var angle2 = controls.getAzimuthalAngle();
    if (fwdValue > 0) {
      tempVector.set(0, 0, -fwdValue).applyAxisAngle(upVector, angle2);
      mesh.position.addScaledVector(tempVector, mult);
    }
    if (bkdValue > 0) {
      tempVector.set(0, 0, bkdValue).applyAxisAngle(upVector, angle2);
      mesh.position.addScaledVector(tempVector, mult);
    }
    if (lftValue > 0) {
      tempVector.set(-lftValue, 0, 0).applyAxisAngle(upVector, angle2);
      mesh.position.addScaledVector(tempVector, mult);
    }
    if (rgtValue > 0) {
      tempVector.set(rgtValue, 0, 0).applyAxisAngle(upVector, angle2);
      mesh.position.addScaledVector(tempVector, mult);
    }
  ...
  return import_react.default.createElement(import_react.default.Fragment, null, import_react.default.createElement(PerspectiveCamera, _extends({}, camProps, {
    ref: camRef
  })), import_react.default.createElement(OrbitControls, _extends({
    autoRotate: false,
    enableDamping: false,
    enableZoom: false,
    enablePan: false,
    ...
    ref: orbitRef
  })), import_react.default.createElement("mesh", {
    position: orbitProps.target || [
      0,
      0,
      0
    ],
    visible: false,
    ref: meshRef
  }, import_react.default.createElement("boxGeometry", {
    args: [
      1,
      1,
      1
    ]
  }), import_react.default.createElement("meshStandardMaterial", {
    color: "white"
  })));
};
export {
...
//# sourceMappingURL=react-three-fpscontrols.js.map
