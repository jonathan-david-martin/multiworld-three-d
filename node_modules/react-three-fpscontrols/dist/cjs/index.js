...
var FPSControls = function(param) {
    ...
    var orbitRef = React.useRef();
    var camRef = React.useRef();
    var meshRef = React.useRef();
    var updatePlayer = React.useCallback(function() {
    ...
    return /*#__PURE__*/ React__default["default"].createElement(React__default["default"].Fragment, null, /*#__PURE__*/ React__default["default"].createElement(drei.PerspectiveCamera, _extends({}, camProps, {
        ref: camRef
    })), /*#__PURE__*/ React__default["default"].createElement(drei.OrbitControls, _extends({
        autoRotate: false,
        enableDamping: false,
        enableZoom: false,
        enablePan: false,
        ...
        visible: false,
        ref: meshRef
    }, /*#__PURE__*/ React__default["default"].createElement("boxGeometry", {
        args: [
            1,
            1,
            1
